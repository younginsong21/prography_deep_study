...
trainset = dset.ImageFolder(root="C:/Users/young/Pictures/Simpsom_classification/train", transform=transform)
trainloader = torch.utils.data.DataLoader(trainset,
                                          batch_size=batch_size,
                                          shuffle=True)

testset = dset.ImageFolder(root="C:/Users/young/Pictures/Simpsom_classification/test",transform=transform)
...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(), 'mini_pj_simpson_model.ckpt')
